...
export const layout = {
  ...
  l2: {
    tr1: [{colspan: 1, rowspan: 1, width: 50, height: 100, id: 1}, {
      colspan: 1,
      rowspan: 1,
      width: 50,
      height: 100,
  ...
  l3: {
    tr1: [{colspan: 2, rowspan: 1, width: 100, height: 50, id: 1}],
    tr2: [{colspan: 1, rowspan: 1, width: 50, height: 50, id: 2}, {
      colspan: 1,
      rowspan: 1,
      width: 50,
      height: 50,
  ...
  l4: {
    tr1: [{colspan: 2, rowspan: 1, width: 100, height: 33, id: 1}],
    tr2: [{colspan: 1, rowspan: 1, width: 50, height: 33, id: 2}, {
      colspan: 1,
      rowspan: 1,
      width: 50,
      height: 33,
    ...
    tr3: [{colspan: 2, rowspan: 1, width: 100, height: 33, id: 4}]
  },
  l5: {
    tr1: [{colspan: 2, rowspan: 1, width: 100, height: 20, id: 1}],
    tr2: [{colspan: 1, rowspan: 1, width: 50, height: 20, id: 2}, {
      colspan: 1,
      rowspan: 1,
      width: 50,
      height: 20,
    ...
    tr3: [{colspan: 2, rowspan: 1, width: 100, height: 20, id: 4}],
    tr4: [{colspan: 1, rowspan: 1, width: 50, height: 20, id: 5}, {
      colspan: 1,
      rowspan: 1,
      width: 50,
      height: 20,
    ...
    tr5: [{colspan: 2, rowspan: 1, width: 100, height: 20, id: 7}]
  }
}
...
export const pielabels = [{'text': '名称', 'value': 'n'}, {'text': '名称+值', 'value': 'nv'}, {
  'text': '名称+比例',
  'value': 'np'
}]

export const legendpos = [{text: '右上', value: 'righttop'}, {text: '中上', value: 'centertop'}, {
  text: '中下',
  value: 'centerbottom'
}]
...
export const compFireEvent = (link, ts, paramName, value) => {
  ...
  $(target.split(',')).each((a, b) => {
    let loadingInstance = Loading.service({
      fullscreen: false,
      target: document.querySelector('#c_' + b + ' div.ccctx')
    })
